...
<body class="">
    ...
    <!-- Sharrre libray -->
    <script src="{{asset('assets')}}/js/core/jquer.min.js"></script>
    <script>
        $(document).ready(function() {
    ...
    <noscript>
        <img height="1" width="1" style="display:none" src="{{asset("https://www.facebook.com/tr?id=111649226022273&ev=PageView&noscript=1")}}" />
    </noscript>
    <script>
        $(document).ready(function() {
            // Javascript method's body can be found in {{asset('assets')}}/js/demos.js
